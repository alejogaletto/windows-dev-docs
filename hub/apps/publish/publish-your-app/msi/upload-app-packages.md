...
You can submit apps to the Microsoft Store in over 100 languages. Your app must support at least one of the supported languages, to find out which languages are supported see [Supported languages](/hub/apps/publish/publish-your-app/faqs/supported-languages.md).
